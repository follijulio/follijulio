...
Graduando em **Matemática (UFAL)** com transição para **Ciência da Computação** e formado como **Técnico em Informática (IFAL)**. Atuo como desenvolvedor Fullstack, focando no ecossistema JavaScript/TypeScript e no processamento de dados governamentais e legislativos.

* **Acadêmico:** Foco em Algoritmos, Estruturas de Dados e Otimização com C.
* **Profissional:** Experiência com arquitetura de sistemas web e consumo de APIs.
